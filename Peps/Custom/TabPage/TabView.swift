...
internal class TabView: UIView {
    ...
    @IBOutlet fileprivate var currentBarView: UIView!
    @IBOutlet fileprivate var currentBarViewWidthConstraint: NSLayoutConstraint!
    @IBOutlet fileprivate var currentBarViewHeightConstraint: NSLayoutConstraint!
    @IBOutlet fileprivate var bottomBarViewHeightConstraint: NSLayoutConstraint!
...
extension TabView: UICollectionViewDataSource {
    internal func collectionView(_: UICollectionView, numberOfItemsInSection _: Int) -> Int {
...
extension TabView: UICollectionViewDelegateFlowLayout {
    internal func collectionView(_ collectionView: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
